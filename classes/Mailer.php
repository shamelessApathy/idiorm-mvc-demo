...
class Mailer {
	...
	function purchase_confirmation($user_id, $items)
	{
		...
		$html = "<em>Stock Photography <strong>Sharefuly</strong></em><br><p>You can view all of your purchased images <a href='/user/purchased_images'>here</a> by logging in!</p>";
