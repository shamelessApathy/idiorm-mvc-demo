...
/* macros.twig */
class __TwigTemplate_49952381df4c4243a5a9e1cab93472dea01dbf956d5cf94bc343eeb47b7dd016 extends Twig_Template
{
    ...
    public function getlogoHtml($__metadata__ = null, $__alt__ = "", ...$__varargs__)
    {
        ...
        try {
            ...
            if ($this->getAttribute(($context["metadata"] ?? null), "logo", array(), "array", true, true)) {
                ...
                echo \Piwik\piwik_escape_filter($this->env, ($context["alt"] ?? $this->getContext($context, "alt")), "html", null, true);
                echo " ";
                echo \Piwik\piwik_escape_filter($this->env, ((array_key_exists("width", $context)) ? (_twig_default_filter(($context["width"] ?? $this->getContext($context, "width")), "")) : ("")), "html", null, true);
                echo " ";
                echo \Piwik\piwik_escape_filter($this->env, ((array_key_exists("height", $context)) ? (_twig_default_filter(($context["height"] ?? $this->getContext($context, "height")), "")) : ("")), "html", null, true);
                echo " src='";
...
{% endmacro %}", "macros.twig", "/var/www/idiorm/idiorm-mvc-demo/analytics/piwik/plugins/Morpheus/templates/macros.twig");
    }
}
