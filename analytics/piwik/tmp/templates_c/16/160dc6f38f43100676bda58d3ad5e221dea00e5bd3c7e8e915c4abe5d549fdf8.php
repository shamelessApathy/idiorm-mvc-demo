...
/* ajaxMacros.twig */
class __TwigTemplate_dc0ca40b293e8c8032485aee64a8d02b95cc294cfdf9bcab3484c7ca12784844 extends Twig_Template
{
    ...
    public function getrequestErrorDiv($__emailSuperUser__ = null, $__areAdsForProfessionalServicesEnabled__ = false, $__currentModule__ = "", ...$__varargs__)
    {
        ...
        <div class=\"alert alert-danger\">
            ...
            if (($context["areAdsForProfessionalServicesEnabled"] ?? $this->getContext($context, "areAdsForProfessionalServicesEnabled"))) {
                ...
                ";
                // line 34
                $context["supportUrl"] = (("https://piwik.org/support/?pk_campaign=Help&pk_medium=AjaxError&pk_content=" . ($context["currentModule"] ?? $this->getContext($context, "currentModule"))) . "&pk_source=Piwik_App");
                // line 35
...
{% endmacro %}", "ajaxMacros.twig", "/var/www/idiorm/idiorm-mvc-demo/analytics/piwik/plugins/Morpheus/templates/ajaxMacros.twig");
    }
}
