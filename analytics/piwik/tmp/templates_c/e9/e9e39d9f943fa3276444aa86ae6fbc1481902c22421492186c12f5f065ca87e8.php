...
class __TwigTemplate_01368ba49aed804f20b60413655765df5ed03a7d753521d4e9d84648be5993ab extends Twig_Template
{
...
array_key_exists("idSubtable", $context)) ? (_twig_default_filter(($context["idSubtable"] ?? $this->getContext($context, "idSubtable")), false)) : (false)));
        // line 5
...
";
        ...
        <tbody>";
            ...
            if ((($context["showingEmbeddedSubtable"] ?? $this->getContext($context, "showingEmbeddedSubtable")) && ($this->getAttribute(($context["dataTable"] ?? $this->getContext($context, "dataTable")), "getRowsCount", array(), "method") == 0))) {
                // line 15
                echo "            ";
                if ((( !array_key_exists("clientSideParameters", $context) ||  !$this->getAttribute(($context["clientSideParameters"] ?? null), "filter_pattern_recursive", array(), "any", true, true)) ||  !$this->getAttribute(($context["clientSideParameters"] ?? $this->getContext($context, "clientSideParameters")), "filter_pattern_recursive", array()))) {
                    // line 16
...
($context["properties"] ?? null), "replace_row_with_subtable", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute(($context["properties"] ?? null), "replace_row_with_subtable", array()), false)) : (false)));
                    ...
                    ";
                        ...
                        foreach ($context['_seq'] as $context["_key"] => $context["column"]) {
                            ...
                            ";
                            // line 42
                            $this->loadTemplate("@CoreHome/_dataTableCell.twig", "@CoreVisualizations/_dataTableViz_htmlTable.twig", 42)->display(array_merge($context, ($context["properties"] ?? $this->getContext($context, "properties"))));
                            // line 43
                            echo "                        </td>
                    ";
                            ++$context['loop']['index0'];
                ...
                ";
                    ...
                    if (((($this->getAttribute(($context["properties"] ?? null), "show_expanded", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute(($context["properties"] ?? null), "show_expanded", array()), false)) : (false)) && ($context["rowHasSubtable"] ?? $this->getContext($context, "rowHasSubtable")))) {
                        // line 50
                        echo "                    ";
                        $this->loadTemplate("@CoreVisualizations/_dataTableViz_htmlTable.twig", "@CoreVisualizations/_dataTableViz_htmlTable.twig", 50)->display(array_merge($context, array("dataTable" => $this->getAttribute($context["row"], "getSubtable", array(), "method"), "idSubtable" => ($context["rowSubtableId"] ?? $this->getContext($context, "rowSubtableId")))));
                        // line 51
                        echo "                ";
                    }
                    ++$context['loop']['index0'];
...
{% else %}
    ...
    {%- endif -%}
{% endif %}", "@CoreVisualizations/_dataTableViz_htmlTable.twig", "/var/www/idiorm/idiorm-mvc-demo/analytics/piwik/plugins/CoreVisualizations/templates/_dataTableViz_htmlTable.twig");
    }
}
